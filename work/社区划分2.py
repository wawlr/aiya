...
G = constructG("fos_title_every_year_data_both_exist.txt")
...
output = open("F:/classify_data/newMaterials/title_fos/fos_title_every_year_data_both_exist_new_result.txt", 'w')
n = 0
