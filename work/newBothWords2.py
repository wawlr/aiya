...
if __name__ == '__main__':
    ...
    paper_dic = {}
    file_read = open(r"F:\classify_data\newMaterials\title_fos\fos_title_every_year_data.txt",'r',encoding='utf-8')
    file_write = open(r"F:\classify_data\newMaterials\title_fos\fos_title_every_year_data_both_exist.txt",'w',encoding='utf-8')
    file_write2 = open(r"F:\classify_data\newMaterials\title_fos\fos_title_every_year_data_words.txt",'w',encoding='utf-8')
    # file_read = open(r"F:\classify_data\aerospace\title_fos.txt", 'r', encoding='utf-8')
    # file_write = open(r"F:\classify_data\aerospace\title_fos\fos_title_every_year_data_both_exist20.txt", 'w',
    #                   encoding='utf-8')
    # file_write2 = open(r"F:\classify_data\aerospace\title_fos\fos_title_every_year_data_words2.txt", 'w',
    #                    encoding='utf-8')
        ...
        for key_j in paper_dic.keys():
            if int(key_i) < int(key_j):
                ...
                if count // 30000000 == 1:
                    ...
                    file_write.close()
                    file_write = open(
                        r"F:\classify_data\newMaterials\title_fos\fos_title_every_year_data_both_exist" + str(
    ...
    file_write.close()
    file_write2.close()
    print("finish file ：" + str(time.time() - start_time))
    file_write2.close()